...
For this course you will be learning with the [The Web Development Bootcamp 2022](...) on Udemy. Even if you really want to learn JavaScript very early, we strongly suggest beginners to follow the provided order of the courses as their contents build on eachother.

You won't need to watch the whole course to finish the project. Because this will be a simple frontend project and the second part of the Udemy course is all about backend. During the course there also a lot of sections in which you will build things. You can skip those sections if you like to but if you have the time try them on your own you learn the most building stuff and apply what you have learned.
...
7. CSS: The World of CSS Selectors
8. The CSS Box Model
9. Responsive CSS & Flexbox
10. JavaScript Basics!
11. JavaScript String and More
12. JavaScript Decision Making
13. JavaScript Arrays
14. JavaScript Object Literals
15. JavaScript Repeating Stuff With Loops
16. NEW: Introducing Functions
17. Callbacks & Array Methods
18. Introducing The World Of The DOM
19. The Missing Piece: DOM Events
20. Async JavaScript: Oh Boy!
21. AJAX and API's