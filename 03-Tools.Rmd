...
In JavaScript we use the [Fetch API](https://developer.mozilla.org/de/docs/Web/API/Fetch_API) to make our API call.  You will learn more about how to use it in section 28 of the Udemy course, but to provide you with a template for later on and as a reminder, this is one way of how to deal with fetch:
```{javascript}
