...
![](https://github.com/tech-academy-ev/SoSe22_Weather_App_Guide/blob/chapter_one/imgs/css_example.png)
```
.bold-text {
  font-weight: bold;
  color: red;
...
![](https://github.com/tech-academy-ev/SoSe22_Weather_App_Guide/blob/chapter_one/imgs/box-model.png)
...
![](https://github.com/tech-academy-ev/SoSe22_Weather_App_Guide/blob/chapter_one/imgs/ta-website.png)
